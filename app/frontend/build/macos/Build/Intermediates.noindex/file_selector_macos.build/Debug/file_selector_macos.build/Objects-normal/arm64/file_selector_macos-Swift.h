...
#ifndef FILE_SELECTOR_MACOS_SWIFT_H
#define FILE_SELECTOR_MACOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="file_selector_macos",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19file_selector_macos18FileSelectorPlugin")
@interface FileSelectorPlugin : NSObject <FlutterPlugin>
