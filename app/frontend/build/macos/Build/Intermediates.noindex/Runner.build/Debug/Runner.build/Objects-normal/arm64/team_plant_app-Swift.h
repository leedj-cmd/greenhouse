...
#ifndef TEAM_PLANT_APP_SWIFT_H
#define TEAM_PLANT_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="team_plant_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14team_plant_app11AppDelegate")
...
SWIFT_CLASS("_TtC14team_plant_app17MainFlutterWindow")
